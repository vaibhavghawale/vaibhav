...
public class Demo {
	public static void main(String[] args) {
	    ...
	    System.out.println();
	    System.out.println("1. for Appoint new Employee"); System.out.println();
	    System.out.println("2. for Tracking Address of Employee"); System.out.println();
	    System.out.println("3. for Delete (Terminate) Employee"); System.out.println();
	    System.out.println("4. for Give Bonus to Employee"); System.out.println();
